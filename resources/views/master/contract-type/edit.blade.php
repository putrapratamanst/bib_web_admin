                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="code" name="code" value="{{ $contractType->code }}" maxlength="20" />
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="mb-3">
                            <label for="name" class="form-label">Name<sup class="text-danger">*</sup></label>
                            <input type="text" class="form-control" id="name" name="name" value="{{ $contractType->name }}" maxlength="50" />
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        $("#formEdit").submit(function(e) {
            ...
            $.ajax({
                url: "{{ route('api.contract-types.update', $contractType->id) }}",
                method: "PUT",
                data: $(this).serialize(),
                beforeSend: function() {
                ...
                error: function(xhr) {
                    ...
                    let message = 'Failed to update Contract Type';
