    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="{{ route('contact.create') }}" class="btn btn-primary btn-sm">Create</a>
            </div>
        </div>
        <div class="card-body">
            ...
            <table class="table table-bordered table-hover table-striped table-sm">
                ...
                <tbody>
                    @forelse ($contacts as $r)
                        <tr wire:key={{ $r->id }}>
                            <td>{{ $r->code }}</td>
                            <td>{{ $r->type()->first()->type_display }}</td>
                            <td>{{ $r->name }}</td>
                            <td>{{ $r->email }}</td>
                            <td>{{ $r->phone }}</td>
                            <td class="text-center">
                                <a href="{{ route('contact.edit', $r->id) }}" class="btn btn-outline-primary btn-sm">Edit</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
