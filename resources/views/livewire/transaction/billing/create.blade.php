<div>
    <div wire:ignore.self class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="createBilling">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel2">Create Billing</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div wire:ignore>
                                        <select id="contract_number" data-placeholder="-- choose contract number --">
                                            <option value=""></option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <div wire:ignore>
                                        <input type="text" class="form-control datepicker" id="due_date" placeholder="dd-mm-yyyy" readonly required />
                                    </div>
                                    @error('due_date')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
...
<script>
    $(document).ready(function () {
        ...
        $("#contract_number").select2({
            theme: "bootstrap-5",
            dropdownParent: $('#createBilling')
        });

        $('#contract_number').on('change', function (e) {
            var data = $('#contract_number').val();
            @this.set('contract_number', data);
        });
    });

    Livewire.on('billing.created', (event) => {
        $("#contract_number").val('').trigger('change');
        $('#date').val('');
        $('#due_date').val('');
        $('#amount').val('');
        $("#createBilling").modal('hide');
    });
</script>
@endpush
