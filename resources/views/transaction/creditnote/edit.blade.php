                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="ref_sistem_lama" id="ref_sistem_lama" class="form-control @error('ref_sistem_lama') is-invalid @enderror" value="{{ old('ref_sistem_lama', $creditNote->ref_sistem_lama) }}" placeholder="Ref Sistem Lama">
