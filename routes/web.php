...
Route::prefix('transaction')->group(function () {
    ...
    Route::get(
        ...
        [\App\Http\Controllers\Transaction\CreditNoteController::class, 'edit']
    )->name('transaction.credit-notes.edit');
    Route::get(
    ...
    Route::get('/payment-allocations/{id}/print', [\App\Http\Controllers\Transaction\PaymentAllocationController::class, 'print'])->name('transaction.payment-allocations.print');
    Route::get('/payment-allocations/{id}/print-payment', [\App\Http\Controllers\Transaction\PaymentAllocationController::class, 'printPayment'])->name('transaction.payment-allocations.print-payment');
